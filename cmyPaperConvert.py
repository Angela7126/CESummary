...
# Purpose:     1. Convert "Paper" object list storing at ./PK/KGPaperList.pk file into "sentText" object list
#              2. "Paper" class refer to ../cmyPreprocess.py
#              3. "sentText" class refer to ./sxpPackage.py
#
# Author:      cmy
#
# Created:     27/09/2016
# Copyright:   (c) cmy 2016
...
def is_relevant(sentences, s, t):
    ...
    for eachs in sentences:
        sim = Similarity(eachs.sentence_text, s)
        if sim > max_dis:
            max_dis = sim
...
# ---- PaperObj2sxpTextObj convert a "Paper1" object (see cmyAddCEid.py) to "sxpText" object (see sxpPackage.py) ---- #
# Input:
...
if __name__ == '__main__':
    ...
    # fp = r'E:\Programs\Eclipse\CE_relation\CEsummary\PK\TXT\f0001_1.pk'
